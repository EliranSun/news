...
export const Calendars = {
    ...
    Game: {
        ...
        legend: [
            { name: "yes", label: "yes", color: Colors.Violet },
            { name: "no", label: "no", color: Colors.Black },
        ],
        icon: "🎮",
        category: Categories.Creative,
    ...
    Media: {
        ...
        legend: [
            { name: "yes", label: "yes", color: Colors.Crimson },
            { name: "no", label: "no", color: Colors.Black },
        ],
        icon: "🎬",
        category: Categories.Creative,
    ...
    Groceries: {
        ...
        legend: [
            { name: "yes", label: "yes", color: Colors.Forestgreen },
            { name: "no", label: "no", color: Colors.Black },
        ],
        icon: "🛒",
        category: Categories.House,
    ...
    Cooking: {
        ...
        legend: [
            { name: "yes", label: "yes", color: Colors.Orange },
            { name: "no", label: "no", color: Colors.Black },
        ],
        icon: "🍳",
        category: Categories.House,
    ...
    ReplaceSheets: {
        ...
        legend: [
            { name: "yes", label: "yes", color: Colors.Lavendar },
            { name: "no", label: "no", color: Colors.Black },
        ],
        icon: "🛏️",
        category: Categories.House,
    ...
    Trip: {
        ...
        legend: [
            { name: "yes", label: "yes", color: Colors.Turquoise },
            { name: "no", label: "no", color: Colors.Black },
        ],
        icon: "🌲",
        category: Categories.Wife,
    ...
    SocialMedia: {
        ...
        legend: [
            { name: "yes", label: "yes", color: Colors.Darkgray },
            { name: "no", label: "no", color: Colors.Black },
        ],
        icon: "📱",
    ...
    Masturbate: {
        ...
        legend: [
            { name: "yes", label: "yes", color: Colors.Brown },
            { name: "no", label: "no", color: Colors.Black },
        ],
        icon: "🚫",
        category: Categories.Avoid,
