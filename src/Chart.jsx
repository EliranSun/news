    ...
    return (
        <div className="flex flex-col md:flex-row">
            <div className="flex w-full mb-2">
                <button className="w-full" onClick={() => setDataLimit(50)}>50</button>
                <button className="w-full" onClick={() => setDataLimit(10)}>10</button>
            </div>
            ...
            <div className="flex w-full mb-2">
                <button className="w-full" onClick={() => setScoreBy('score')}>Score</button>
                <button className="w-full" onClick={() => setScoreBy('episode')}>Episode</button>
            </div>
            <div
                className="border h-[50vh] overflow-y-auto  w-full md:w-[50vw] m-auto text-base">
                {[...data].sort((a, b) => {
                    if (sortBy === 'score') {
                        return b.y - a.y;
                    }
